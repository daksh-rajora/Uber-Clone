    ...
    <div>
     <h5 className='p-3 text-center absolute top-0 w-[93%]' onClick={()=>{
        ...
        <div className='flex items-center justify-between'>
          <img className='h-18' src={vehicleImages[props.vehicleType]} alt="" />
          <div className='text-right'>
            <h2 className='text-lg font-medium'>Daksh</h2>
            <h4 className='font-semibold text-xl -mt-1 -mb-1 '>PB0A5558</h4>
            <p className='text-sm text-gray-600'>{driverVehicles[props.vehicleType]}</p>
          </div>
        </div>
        ...
        <div className='w-full mt-5'>
          ...
          <div className='flex items-center gap-5 p-3 border-t border-gray-100'>
            <i className='ri-shield-flash-line text-lg text-yellow-500'></i>
            <div>
              <h3 className='text-lg font-semibold tracking-wider'>OTP: {props.ride?.otp}</h3>
              <p className='text-sm text-gray-500 -mt-1'>Share this with driver to start the ride</p>
            </div>
          </div>
        </div>
        </div>
